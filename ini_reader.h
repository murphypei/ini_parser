...
public:
    ...
    std::vector<int> GetIntArray(const std::string &section, const std::string &name) const;

    std::vector<std::string> GetStrArray(const std::string &section, const std::string &name) const;

    std::vector<float> GetRealArray(const std::string &section, const std::string &name) const;
...
private:
    ...
    void stringSplit(const std::string &src, const std::string &delim, std::vector<std::string> &parts) const;
};
